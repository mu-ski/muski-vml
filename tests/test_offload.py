...
# def test_get_playlist_offload_spotify_4():
#     l = ["Baba Maal - Kum Kum","Khruangbin - Maria Tambien","Fela Kuti - Zombie",
#             "Caetano Veloso - Nao Wants to Be Kissed","Ali Farka Toure - Savane",
#             "The Souljazz Orchestra - Lufua","Tinariwen - Assouf","Jorge Ben - Taj Mahal",
#             "Antibalas - Ile Oy Lou","Anoushka Shankar - Traces of You"]
#     make_playlist(l, "Chill World Vibes")
