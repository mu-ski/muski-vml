...
def greet():
    ...
    printn(" >> 1. First, you give the Muze access to your spotify: it uses your spotify data to create a new Muze account and understands what music you like.")
    ...
    printn(" >> Ready to start? 😀 As soon as you press enter ⏎, your browser will open the spotify website, and you will be asked to allow Muze to read your data.") 
...
def query_user():
    ...
    ans1 = printn(" >> First: Tell us below 👇 what does music mean to you? And when do you typically listen to music? (Take your time and get creative, the more detail, the better 😉)", empty_return=False)
...
def query_user_playlist():
    ans3 = printn(" >> What's your mood like right NOW, what music do you feel like listening to? (Ex., 'sunny saturday morning music from Mali',  '70s disco music')", empty_return=False)
    if not ans3:
